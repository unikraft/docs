...
Let's start with the [`helloworld-gcc13.2`](https://github.com/unikraft/catalog/tree/main/examples/helloworld-gcc13.2) application.
...
Follow the same steps with [`hugo`](https://github.com/unikraft/catalog/tree/main/library/hugo/0.122).
Create a `Makefile`, build the application and then run it.
