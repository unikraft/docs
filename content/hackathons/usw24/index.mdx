...
USW'24 will be held by members of the Unikraft community including professors and students from [The National University of Science and Technology POLITEHNICA of Bucharest](https://upb.ro/) and the comercial side of Unikraft, [`Unikraft.com`](https://unikraft.com/).
...
For the next 3 sessions, we will use [Unikraft Cloud](https://unikraft.com/docs) to deploy our applications.
