...
USW'25 will be held by members of the Unikraft community including professors and students from [The National University of Science and Technology POLITEHNICA of Bucharest](https://upb.ro/) and the comercial side of Unikraft, [`Unikraft.com`](https://unikraft.com/).
...
For this session we will build and run unikernels manually, without using scripts.
We will see how to configure the applications and we will use networking and filesystems.

Follow the steps under [the `Internals` guide](/guides/internals), and mark the items in [this form](https://forms.gle/7VK5MQS1BbrM9oYNA).

#### Session 3 - Debugging

In this session, we will learn how to debug unikernels using `gdb`, logging and other similar tools.

Follow the steps under [the `Debugging` guide](/guides/debugging), and mark the items in [this form](https://forms.gle/rm3JjY523HFwPQ4p6).

#### Session 4 - Basic Application Porting

In this session, we will start porting some basic applications.

Follow the steps under the [`application porting` guide](/guides/basic-porting), and mark the items in [this form](https://forms.gle/KpFQyeGAg2isCTfx7).

#### Session 5 - Binary Compatibility

In this session, we will learn how to use already compiled applications with Unikraft.

Follow the steps under the [`bincompat` guide](/guides/bincompat), and mark the items in [this form](https://forms.gle/mFrCXU3gp1PAq7Au8).

#### Session 6 - Advanced Application Porting

In this session, we will learn how to port more complex applications as libraries to run with Unikraft

Follow the steps under the [`advanced porting` guide](/guides/advanced-porting), and mark the items in [this form](https://forms.gle/UqLTzFCYABX8pYvq6).
