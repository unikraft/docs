Contrary to popular belief, debugging an unikernel is in fact simpler than debugging a standard operating system.
...
2. Use `make V=1` to see verbose output for all the commands being executed during the build.
