...
description: |
  Unikraft is a faster and more secure alternative to running your
  application in a container or Linux VM.  Instantly boost your application with
  minimal effort.
---

<UnikraftCloudBanner mt={8} />

## Overview

Unikraft is a fast, secure and open-source Unikernel Development Kit which
enables you to easily build minimal, ultra-lightweight virtual machines (known
as unikernels). Running your application with Unikraft provides:
...
Please note that this is the documentation page for the Unikernel LibOS. 
For the commercial cloud solution that runs arbitrary workloads like AI agents, 
sandboxes, databases, full virtual computers, and much more -- please visit
[unikraft.com](https://unikraft.com).
...
We've put together an application [**catalog**](https://github.com/unikraft/catalog/tree/main/examples) with step-by-step guides: click on one of the following items and follow the instructions in the `README.md`.
Alternatively, go back to our [landing page](https://unikraft.org/) and click on one of the app or language badges.
