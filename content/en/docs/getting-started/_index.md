...
As an alternative to `kraft` it is also possible to build Unikraft using a regular [`Makefile`](#building-unikraft-via-makefile).
...
See [here](../operations/plats/kvm.md) for further information on running the unikernel with KVM.
