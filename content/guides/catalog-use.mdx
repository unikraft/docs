...
The catalog stores both native builds and [binary-compatible](/docs/concepts/bincompat) builds of Unikraft applications.
...
The `base` entry is a meta-application that is being used in [binary-compatibility mode](/docs/concepts/bincompat) to run other applications and examples.
