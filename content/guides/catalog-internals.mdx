---
title: "Application Catalog: Behind the Scenes"
description: |
...
The [guide on using the application catalog](/guides/catalog) provides the user-friendly information on using the Unikraft application registry and the [`catalog` repository](https://github.com/unikraft/catalog).
...
It is aimed for those more technically inclined who would be interested in understanding what's happening behind the scenes and maybe [contribute to the application catalog](/guides/catalog-add).

Similar to the [guide on using the application catalog](/guides/catalog), we will use two applications:
