---
title: "Application Catalog: Using Firecracker"
description: |
  This guide presents internal technical information about using Firecracker with the application catalog.
---

This guide is a companion to the ["Application Catalog: Behind the Scenes" guide](/guides/catalog-internals).
...
<Info>
Note that Firecracker requires hardware virtualization support (KVM).
