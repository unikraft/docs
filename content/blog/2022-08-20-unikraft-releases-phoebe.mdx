...
<Image
  ...
  maxW={'2xl'}
  ratio={5/3}
  src="/images/posix-socket.svg"
  description="Example of how posix-socket redirects the use of socket() calls to different implementations."
/>
...
<Info>
Output will be totally out of order as the cores output characters in parallel ;-)
</Info>
