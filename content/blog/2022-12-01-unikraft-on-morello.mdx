...
- security
- research
image: /images/morello-unikraft-machine.jpg
---
...
<Image
  ...
  maxW={'2xl'}
  ratio={5/3}
  src="/images/morello-unikraft-fvp.png"
...
<Image
  ...
  maxW={'2xl'}
  ratio={5/3}
  src="/images/morello-unikraft-build-option.png"
  description="The new Morello option which can be enabled in the Unikraft platform configuration menu"
/>
